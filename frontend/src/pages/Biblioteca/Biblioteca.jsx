    ...
    return (
        <div className="app-layout">
            ...
            <main className="biblioteca-main">
                ...
                <p>
                    Aqui você encontra materiais auxiliares para as suas aulas
                    compartilhados por professores e outros alunos!
                </p>
                ...
                <div className="add-content-wrapper">
                    ...
                    <button
                        className="btn btn-primary add-content"
                ...
                <div className="container-fluid pdf-wrapper">
